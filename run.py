...
for xc in range(10000):
    ...
    u3 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(realme))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]"
    u4 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(realme))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]"
    u5 = f"Mozilla/5.0 (Linux; Android {str(rr(2, 16))}; {str(rc(realme))} Build/SP1A{str(rr(111111,299999))}.0{str(rr(0,2))}{str(rr(0,9))}; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(95,100))}.0.{str(rr(4638,4999))}.{str(rr(74,150))} MobileSafari/537.36 [FB_IAB/FB4A;FBAV/340.0.0.27.113;]" 
